...
class navigator:
    ...
    def tmdbMovieCollections(self):
        self.addDirectoryItem('Collections Page 1', 'movies_tmdb_collections&url=page1', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 2', 'movies_tmdb_collections&url=page2', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 3', 'movies_tmdb_collections&url=page3', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 4', 'movies_tmdb_collections&url=page4', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 5', 'movies_tmdb_collections&url=page5', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 6', 'movies_tmdb_collections&url=page6', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 7', 'movies_tmdb_collections&url=page7', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 8', 'movies_tmdb_collections&url=page8', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 9', 'movies_tmdb_collections&url=page9', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 10', 'movies_tmdb_collections&url=page10', 'tmdb.png', 'DefaultMovies.png')
        self.addDirectoryItem('Collections Page 11', 'movies_tmdb_collections&url=page11', 'tmdb.png', 'DefaultMovies.png')
        self.endDirectory()
    ...
    def moreplugs(self):
        ...
        self.addDirectoryItem('NightRide: StreamSafe Songs', 'nightride_streamsafe_menu', 'most-popular.png', 'DefaultSets.png')
        self.addDirectoryItem('NightRide: Stations', 'nightride_stations_menu', 'most-popular.png', 'DefaultSets.png')
        self.addDirectoryItem('Watch [Show] Online', 'watchonline_menu', 'most-popular.png', 'DefaultSets.png')
        self.endDirectory()
    ...
    def myuserlists(self):
        self.addDirectoryItem('Movie UserLists', 'movies_userlists', 'mymovies.png', 'DefaultMovies.png')
        self.addDirectoryItem('TV Show UserLists', 'tvshows_userlists', 'mytvshows.png', 'DefaultTVShows.png')
