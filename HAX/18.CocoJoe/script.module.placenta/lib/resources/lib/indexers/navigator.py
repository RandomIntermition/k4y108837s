...
###### trakt tv setting
#traktintv = control.getsetting('navi.traktintv')
...
## 24/7 main menu item
        if not control.setting('streams.widget') == '0':
            self.addDirectoryItem("Streams", 'streamsNavigator', 'airing-today.png', 'DefaultVideoPlaylists.png')
## 24/7 ENDS

        if control.setting('navi.traktinmainmenu') == 'true':
        ...
        if not control.setting('tv.widget.alt') == '0' or (not control.setting('tv.widget') == '0'):
...
#######################################################################
    ...
    def movies(self, lite=False):
        ...
        if traktCredentials == True:
            if control.setting('navi.traktinmovies') == 'true':
                self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] My Movies Collection", 'movies&url=traktcollection', 'trakt.png', 'DefaultMovies.png', queue=True, context=(32551, 'moviesToLibrary&url=traktcollection'))
                self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] Coming Soon", 'movies&url=traktcomingsoon', 'trakt.png', 'DefaultMovies.png', queue=True)
                self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] Latest Releases", 'movies&url=traktlatestrelease', 'trakt.png', 'DefaultMovies.png', queue=True)
                self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] Top 10 Weekly", 'movies&url=trakttoptenweekly', 'trakt.png', 'DefaultMovies.png', queue=True)


        if lite == False:
            if not control.setting('navi.traktlists') == '0':
                self.addDirectoryItem(32003, 'mymovieliteNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')

            if control.setting('navi.libraryinmovies') == 'true':
                self.addDirectoryItem(32638, control.setting('library.movie'), 'mymovies.png', 'DefaultMovies.png', isAction=False)
...
######            self.addDirectoryItem(32035, 'movies&url=featured', 'imdb.png', 'DefaultMovies.png', queue=True)
        ...
        self.addDirectoryItem(32639, 'movieUserlists', 'userlists.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        if traktCredentials == True:
            if control.setting('navi.traktintv') == 'true':
                self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] My Tv Shows Collection", 'tvshows&url=traktcollection', 'trakt.png', 'DefaultTVShows.png', queue=True, context=(32551, 'tvshowsToLibrary&url=traktcollection'))
                #self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] Coming Soon", 'movies&url=traktcomingsoon', 'trakt.png', 'DefaultMovies.png', queue=True)
                #self.addDirectoryItem("[COLOR blue][B][Trakt][/B][/COLOR] Latest Releases", 'movies&url=traktlatestrelease', 'trakt.png', 'DefaultMovies.png', queue=True)
        ...
        if lite == False:
            ...
            if control.setting('navi.libraryintv') == 'true':
                self.addDirectoryItem(32637, control.setting('library.tv'), 'mytvshows.png', 'DefaultTVShows.png', isAction=False)
...
######            self.addDirectoryItem(32035, 'tvshows&url=trending', 'imdb.png', 'DefaultMovies.png', queue=True)
        ...
        self.addDirectoryItem(32639, 'tvUserlists', 'userlists.png', 'DefaultTVShows.png')

        self.endDirectory()

## 24/7 SECTION
    def streams(self):
        self.addDirectoryItem('24/7 - AcronaiTV',  'acronaitv_menu',  'channels.png',  'DefaultTVShows.png')
        self.addDirectoryItem('24/7 - Streamlive', 'streamlive247Navigator', 'channels.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Live - Streamlive', 'streamliveNavigator', 'channels.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Live - usTVgo', 'ustvgoNavigator', 'channels.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Live - SwiftStreamz', 'swiftNavigator', 'channels.png', 'DefaultTVShows.png')
        
        self.endDirectory()

## 24/7 SECTION - END_OF_SECTION


    def tools(self):
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32045, 'openSettings&query=2.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32632, 'openSettings&query=3.0', 'tools.png', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem(32609, 'urlResolver', 'resolveurl.png', 'DefaultAddonProgram.png')
    ...
    def clearCacheSearch(self):
        ...
        if control.yesnoDialog(control.lang(32056).encode('utf-8'), '', ''):
            ...
            #control.refresh() ## maybe need maybe not add back in later if search break
