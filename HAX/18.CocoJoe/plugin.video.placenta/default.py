...
elif action == 'streamsNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().streams()
...
elif action == 'streamlive247Navigator':
    from resources.lib.indexers import streamlive247
    streamlive247.streamlive().root()
