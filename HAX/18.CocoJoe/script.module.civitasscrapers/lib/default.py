...
if mode == "toggleAllDebrid":
    sourcelist = ['0day','300mbfilms','300mbdownload','bestmoviez','ddlvalley','ddlspot','directdl','filmxy','iwantmyshow','moviesleak','mvrls','myvideolink',
    'playmovies','rapidmoviez','rlsbb','scenerls','scnsrc','tvdownload','ultrhd''ultrahdindir','wrzcraft']
...
if mode == "toggleAllTorrent":
    sourcelist = ['1337x','eztv','glodls','kickass2','limetorrents','magnetdl','piratebay','torrentapi','torrentdownloads','yify','zoogle']
    toggleAll(params['setting'], params['open_id'], sourcelist)

if mode == "Defaults":
    sourcelist = ['123moviehd','animetoon','bnwmovies','cartoonhd','cartoonwire','cmovieshdbz','coolmoviezone','deepmovie','fmovies','freefmovies','freeputlocker','furk','gogoanime','gowatchseries','hackimdb','hdmto','hdpopcorns','movie4kis','odb','ororo','primewire','projectfreetv','putlocker','putlockerfree','reddit','seehd','series9','seriesonline','sezonlukdizi','solarmovie','solarmoviez','swatchseries','tvbox','vidics','watchseries','0day','300mbfilms','300mbdownload','bestmoviez','ddlvalley','ddlspot','directdl','filmxy','iwantmyshow','moviesleak','mvrls','myvideolink',
    'playmovies','rapidmoviez','rlsbb','scenerls','scnsrc','tvdownload','ultrhd''ultrahdindir','wrzcraft','1337x','eztv','glodls','kickass2','limetorrents','magnetdl','piratebay','torrentapi','torrentdownloads','yify','zoogle']
    toggleAll(params['setting'], params['open_id'], sourcelist)
