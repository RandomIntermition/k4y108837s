...
def clear_cache():
    ...
    cache_location = os.path.join(
        xbmc.translatePath(
            xbmcaddon.Addon("script.module.universaldebrid").getAddonInfo(
...
def _update_settings_xml():
    settings_location = os.path.join(
        xbmcaddon.Addon('script.module.universaldebrid').getAddonInfo('path'),
    ...
    new_xml = [
        ...
        '\t\t<setting label="Disable All" type="action" option="close" action="RunPlugin(plugin://script.module.universaldebrid/?mode=DisableAll)"/>',
        '\t\t<setting label="Enable All" type="action" option="close" action="RunPlugin(plugin://script.module.universaldebrid/?mode=EnableAll)"/>',
        '\t\t<setting label="Deletelog" type="action" option="close" action="RunPlugin(plugin://script.module.universaldebrid/?mode=Deletelog)"/>',
