...
from universaldebrid.common import clean_title, clean_search, get_rd_domains, send_log, error_log
from universaldebrid.modules import client, dom_parser as dom, workers, quality_tags
...
class piratebay(Scraper):
    ...
    def __init__(self):
        self.base_link = 'https://piratebay.party/'
        self.search_link = '/search/%s/1/99/200'
