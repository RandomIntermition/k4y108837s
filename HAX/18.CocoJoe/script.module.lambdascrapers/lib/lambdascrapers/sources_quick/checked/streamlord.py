...
class source:
    def __init__(self):
        ...
        self.search_link = '/searchapi2.php'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            # SWITCHED TO STATIC QUALITY, SEE BELOW
            ...
            sources.append({'source': 'cdn', 'quality': 'TOP', 'language': 'en', 'url': url, 'direct': True, 'debridonly': False, 'autoplay': True})
