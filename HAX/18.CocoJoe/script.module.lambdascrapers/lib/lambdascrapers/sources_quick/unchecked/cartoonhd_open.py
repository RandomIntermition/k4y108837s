	...
	def sources(self, url, hostDict, hostprDict):
		try:
			...
			try:
				...
				for i in r:
					sources.append({'source': 'gvideo', 'quality': 'TOP', 'language': 'en', 'url': i, 'direct': True, 'debridonly': False})
			except:
				source_utils.scraper_error('CARTOONHD')
				pass
			try:
			...
			for i in r:
				if 'google' in i:
					...
					quality = source_utils.check_url(i)
					sources.append({'source': 'CDN', 'quality': 'TOP', 'language': 'en', 'url': i, 'direct': True, 'debridonly': False})
				else:
					valid, hoster = source_utils.is_host_valid(i, hostDict)
					if not valid:
						continue
					sources.append({'source': hoster, 'quality': 'TOP', 'language': 'en', 'url': i, 'direct': False, 'debridonly': False})
			return sources
		except:
			source_utils.scraper_error('CARTOONHD')
			return sources
