...
from resources.lib.modules import jsunfuck,source_utils,cfscrape
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['solarmovie.to','solarmoviez.ru','solarmovies.co']
    ...
    def searchMovie(self, title, year, aliases, headers):
        try:
            ...
            for i in r:
                try:
                    info = self.s.get(urlparse.urljoin(self.base_link, self.info_link % i[2]), headers=headers, timeout='15').content
