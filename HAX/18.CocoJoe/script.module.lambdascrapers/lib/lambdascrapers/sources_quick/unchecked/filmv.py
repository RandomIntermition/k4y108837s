...
class source:
    def __init__(self):
        ...
        self.domains = ['milversite.online']
        self.base_link = 'http://milversite.online'
        self.search_link = 'https://www.milversite.online/search.php?all=all&keywords=%s&vselect=%s'
