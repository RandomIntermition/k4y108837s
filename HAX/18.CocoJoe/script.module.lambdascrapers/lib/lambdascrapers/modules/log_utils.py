...
from lambdascrapers.modules.modules import control
...
DEBUGSPACER = '[COLOR red][ PLACENTA DEBUG ][/COLOR]' # Using color coding, for color formatted log viewers like Assassin's Tools
